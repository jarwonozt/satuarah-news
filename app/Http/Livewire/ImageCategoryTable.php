...
class ImageCategoryTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Status", "status")
                ->view('admin.images.categories.view.status'),
            Column::make('Actions', 'id')
                ->view('admin.images.categories.view.action'),
        ];
    }
    ...
    public function update()
    {
        ...
        $save->save();
        return redirect()->route('imagecategories.index')->with('message', "Kategori $save->name berhasil diupdate.");
    ...
    public function deleteStatus(){
        $data = ImageCategory::findOrFail($this->selected_id)->delete();
