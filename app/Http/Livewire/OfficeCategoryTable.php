...
{
    protected $model = OfficeCategory::class;
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Status", "status")
                ->view('admin.offices.categories.view.status'),
            Column::make('Actions', 'id')
                ->view('admin.offices.categories.view.action'),
        ];
    }
    ...
    public function update()
    {
        ...
        $save->save();
        return redirect()->route('officecategories.index')->with('message', "Kategori $save->name berhasil diupdate.");
    ...
    public function deleteStatus(){
        $data = OfficeCategory::findOrFail($this->selected_id)->delete();
