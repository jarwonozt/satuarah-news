<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('pages.index') }}">@lang('admin.page.title')</a> /</span> @lang('admin.category.title')</h5>
            <div class="row mb-2">
                <div class="col">
            ...
            <div class="card">
                <div class="card-datatable table-responsive p-2">
                    <livewire:page-category-table theme="bootstrap-5" />
                </div>
            </div>
        </div>
    </div>
