<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y"><h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('users.index') }}">Users</a> /</span> Add New User</h6>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" name="email" type="email" class="form-control" placeholder="cth :user@gmail.com"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="roles" class="form-control" id="basicSelect" required>
                                    ...
                                    <option value="{{ $item->name }}">{{ strtoupper($item->name) }}
                                    </option>
                                    @endforeach
                                </select>
                                @if ($errors->has('roles'))
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="custom-control custom-control-success custom-checkbox">
                                        <input type="checkbox" name="user_type[]" value="{{ $k }}" class="form-check-input" id="colorCheck{{ $k }}">
                                        <label class="custom-control-label me-2" for="colorCheck{{ $k }}">{{
                                            $item }}</label>
                                    </div>
                                    @endforeach
                                </div>
