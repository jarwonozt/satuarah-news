<x-master-layout>
    @section('title')
    @lang('admin.file.title')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Dashboard /</span> @lang('admin.file.title')</h5>
            <div class="row mb-2">
                <div class="col">
                    <a href="{{ route('files.create') }}" class="btn btn-primary">@lang('admin.file.create')</a>
                    <a href="{{ route('filecategories.index') }}" class="btn btn-outline-primary waves-effect">@lang('admin.category.title')</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-datatable table-responsive p-2">
                    <livewire:file-table theme="bootstrap-5" />
                </div>
            </div>
        </div>
    </div>
