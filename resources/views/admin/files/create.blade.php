<x-master-layout>
    @section('title')
        @lang('admin.file.create')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y"><h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('files.index') }}">@lang('admin.file.title')</a> /</span> @lang('admin.file.create')</h6>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input id="title" name="title" type="text" class="form-control" placeholder="@lang('admin.form.title') @lang('admin.file.title')" value="{{ old('title') }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($errors->has('description'))<span class="text-danger">Deskripsi Wajib Isi!!!</span>@endif
                            </div>
                            <div class="mb-3 mt-2">
                                ...
                                <div class="input-group hdtuto control-group lst increment">
                                    <input type="file" name="file[]"
                                        ...
                                        class="myfrm form-control" required>
                                    <div class="input-group-btn">
                                        <button class="add_button btn btn-primary ml-1" type="button"><i class="menu-icon tf-icons ti ti-plus"></i></button>
                                    </div>
                                </div>
                                <div class="clone hide">
                                    <div class="hdtuto control-group lst input-group" style="margin-top:10px">
                                        <input type="file" name="file[]"
                                            ...
                                            class="myfrm form-control" required>
                                        <div class="input-group-btn">
                                            <button class="remove_button btn btn-danger ml-1" type="button"><i class="menu-icon tf-icons ti ti-trash"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
