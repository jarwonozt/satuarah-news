<x-master-layout>
    @section('title')
        @lang('admin.office.title')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('offices.index') }}">@lang('admin.office.title')</a> /</span> @lang('admin.office.create')</h6>
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('offices.store') }}">
            @csrf
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input id="title" name="title" type="text" class="form-control" placeholder="" value="{{ old('title') }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="website" name="website" type="text" class="form-control" placeholder="" value="{{ old('website') }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="preview" class="form-control" rows="4">{{ old('description') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="content" id="preview" class="form-control" rows="4">{{ old('content') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="information" id="preview" class="form-control" rows="4">{{ old('information') }}</textarea>
