<x-master-layout>
    @section('title')
    @lang('admin.category.title') @lang('admin.office.title')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('offices.index') }}">@lang('admin.office.title')</a> /</span> @lang('admin.category.title')</h5>
            <div class="row mb-2">
                <div class="col">
                    <button type="button" id="create" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#createCategory">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="text-center mb-4">
                                        <h3 class="mb-2">@lang('admin.category.create') @lang('admin.office.title')</h3>
                                    </div>
                                    <form action="{{ route('officecategories.store') }}" method="POST" class="row g-3">
                                        @csrf
                                        <div class="col-12">
            ...
            <div class="card">
                <div class="card-datatable table-responsive p-2">
                    <livewire:office-category-table theme="bootstrap-5" />
                </div>
            </div>
        </div>
    </div>
