<x-master-layout>
    @section('title')
        @lang('admin.office.edit')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('offices.index') }}">@lang('admin.office.edit')</a> /</span> @lang('admin.office.create')</h6>
            ...
            <div class="row justify-content-start">
                <div class="col-12 col-md-8 col-xl-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label text-primary fw-bold text-uppercase" for="basic-default">Nama @lang('admin.office.title') </label></span>
                                <input id="title" name="title" type="text" class="form-control" placeholder="" value="{{ $data->title }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category_id" id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default" required>
                                    ...
                                    <option value="{{ $item->id }}" {{ $data->category_id == $item->id ? 'selected' : '' }}>{{ strtoupper($item->name) }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('roles'))
                            ...
                            <div class="mb-3">
                                <label class="form-label text-primary fw-bold text-uppercase" for="basic-default">Alamat Website </label></span>
                                <input id="website" name="website" type="text" class="form-control" placeholder="" value="{{ $data->website }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="preview" class="form-control" rows="4">{{ $data->description }}</textarea>
                                @if ($errors->has('description'))<span class="text-danger">Description Wajib Isi!!!</span>@endif
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-primary fw-bold text-uppercase" for="basic-default">Sejarah</label></span>
                                <textarea name="content" id="preview" class="form-control" rows="4">{{ $data->content }}</textarea>
                                @if ($errors->has('content'))<span class="text-danger">Sejarah Wajib Isi!!!</span>@endif
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-primary fw-bold text-uppercase" for="basic-default">Informasi</label></span>
                                <textarea name="information" id="preview" class="form-control" rows="4">{{ $data->information }}</textarea>
                                @if ($errors->has('information'))<span class="text-danger">Informasi Wajib Isi!!!</span>@endif
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-xl-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-2">
                                    <div class="media flex-column text-center">
                                        <img name="image" src="{{ asset($data->imagePath) }}" alt="users avatar" class="user-avatar users-avatar-shadow rounded my-25 cursor-pointer" width="100%" />
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="custom-control custom-radio ms-2">
                                        <input name="status" type="radio" id="customRadio5" class="form-check-input" value="2" {{ $data->status == 0 ? 'checked' : '' }}/>
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <a href="{{ route('offices.index') }}" class="btn btn-secondary text-uppercase">@lang('admin.cancel')</a>
                        </div>
                    </div>
