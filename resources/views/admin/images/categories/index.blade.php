<x-master-layout>
    @section('title')
    @lang('admin.category.title') @lang('admin.image.title')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('images.index') }}">@lang('admin.image.title')</a> /</span> @lang('admin.category.title')</h5>
            <div class="row mb-2">
                <div class="col">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('imagecategories.store') }}" method="POST" class="row g-3">
                                        @csrf
                                        <div class="col-12">
            ...
            <div class="card">
                <div class="card-datatable table-responsive p-2">
                    <livewire:image-category-table theme="bootstrap-5" />
                </div>
            </div>
        </div>
    </div>
