<div class="modal fade text-left modal-primary" id="detail-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{!! empty($image) ? '' : $image !!}" class="img-fluid card-img-top rounded" alt="{{ $title }}" />
                <div class="row">
