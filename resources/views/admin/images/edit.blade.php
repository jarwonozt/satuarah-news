<x-master-layout>
    @section('title')
    @lang('admin.image.edit')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('images.index') }}">@lang('admin.image.edit')</a> /</span> @lang('admin.image.create')</h6>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input id="title" name="title" type="text" class="form-control" placeholder="@lang('admin.form.title') @lang('admin.image.edit')" value="{{ $data->title }}" required />
                                        @if ($errors->has('title'))<span class="text-danger">{{$errors->first('title')}}</span>@endif
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-primary fw-bold text-uppercase"
                                            for="basic-default">slug/url</label></span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="category_id" id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default" required>
                                            ...
                                            <option value="{{ $item->id }}" {{ $data->getCategory->id == $item->id ? 'selected' : '' }}>{{ strtoupper($item->name) }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('roles'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group mb-2">
                                            <div class="media flex-column text-center">
                                                <img name="image" src="{{ asset($data->imagePath) }}"
                                                    alt="users avatar"
                                                    class="user-avatar users-avatar-shadow rounded my-25 cursor-pointer"
                                                    width="100%" />
