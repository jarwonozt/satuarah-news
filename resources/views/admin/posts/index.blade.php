<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Dashboard /</span> @lang('admin.post.title')</h5>
            <div class="row mb-2">
                <div class="col">
                    <a href="{{ route('posts.create') }}" class="btn btn-primary">@lang('admin.post.create')</a>
                    <a href="{{ route('postcategories.index') }}" class="btn btn-outline-primary waves-effect">@lang('admin.category.title')</a>
                    <a href="{{ route('tags.index') }}" class="btn btn-outline-dark waves-effect">@lang('admin.tag.title')</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-datatable table-responsive p-2">
                    <livewire:post-table theme="bootstrap-5" />
                </div>
            </div>
        </div>
    </div>
