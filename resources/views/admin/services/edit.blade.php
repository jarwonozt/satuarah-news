<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('services.index') }}">@lang('admin.service.title')</a> /</span> @lang('admin.service.edit')</h6>
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('services.update', $data->id) }}">
            @csrf
            @method('PUT')
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input id="title" name="title" type="text" class="form-control" placeholder="@lang('admin.form.title') @lang('admin.service.title')" value="{{ $data->title }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="slug" name="slug" type="text" class="form-control" value="{{ $data->slug }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($errors->has('preview'))<span class="text-danger">Description Wajib Isi!!!</span>@endif
                            </div>
                        </div>
                    </div>
                </div>
