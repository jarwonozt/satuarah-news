<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('photos.store') }}">
            @csrf
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input id="title" name="title" type="text" class="form-control" placeholder="@lang('admin.form.title') @lang('admin.photo.title')" value="{{ old('title') }}" required/>
