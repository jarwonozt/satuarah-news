<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('videos.index') }}">@lang('admin.video.title')</a> /</span> @lang('admin.video.create')</h6>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="title" name="title" type="text" class="form-control" placeholder="@lang('admin.form.title') @lang('admin.video.title')" value="{{ old('title') }}" required/>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="content" id="preview" class="form-control">{{ old('content') }}</textarea>
